...
- `scripts/bootstrap.py` deterministic template initializer: renames the
  package and replaces every placeholder (`pidprobe`, `pidprobe`,
...
- Simplified `src/pidprobe/__init__.py`'s version resolution to the
...
[Unreleased]: https://github.com/tomada1114/pidprobe/commits/main
